...
public class ArticleApiController {
    ...
    public ResponseEntity<Article> update(@PathVariable(value = "id")Long id, @RequestBody ArticleForm form){
    ...
    public ResponseEntity<ArrayList<Article>> transactionTest(@RequestBody ArrayList<ArticleForm> dtos){
        ArrayList<Article> createdList = articleService.createArticles(dtos);
